...
- ***Functionality:***
  ...
  - Reproduce the game Pacman in assembly programming language and add some new features.

  - The primary objective and most crucial one is to make the exact Pacman game, and then,within the time frame, with time not knocking at our door, we add new features to the game.

- ***Compatibility:***
  - TThe game must be compatible with all systems, without any specific preference for operating systems (Linux, MacOS, Windows).
...
- ***Graphics:***
  ...
  - For more advanced graphics, explore DOS graphics interrupts (e.g., INT 10h) to display more detailed and visually appealing sprites for Pac-Man, ghosts, and other game elements.
        ...
        game_board db 20, 20 ; 20x20 game board dimension
                   db '###############' ; Wall
                   db '#.............#'
                   db '#.####.####.#.#' ; Example layout
...
- ***Time-Frame:***
  - Effectively managing time for the project is crucial to ensure proper delivery. An unforeseen challenge in assembly during programming will impact the project's initial delivery date.
...
- ***Learning Curve:***
  - Acknowledge that learning x86 Assembly may pose a steep learning curve, especially for those new to low-level programming, potentially causing delays in the project delivery. Here is a link that contains all the necessary resources to help new users to have a basic level of assembly programming language, NASM, and DOSbox **[Resources](https://www.notion.so/add5b9314345446ca34c5eb2ad43fd80?v=0107bb6307824d24a8b3d7a507bf34ac&pvs=4)**

- ***Debugging Challenges:***
  - Understand that debugging Assembly code can be challenging, and a significant amount of time will be dedicated to debugging and troubleshooting issues that may arise during development.
